...
interface PostLikeBatchService {
    ...
    fun fetchCounts(page: Int, pageSize: Int): List<PostLikeCount>
}
...
class PostLikeBatchServiceImpl(
    ...
    override fun fetchCounts(page: Int, pageSize: Int): List<PostLikeCount> = runBlocking {
        val pageable = PageRequest.of(page, pageSize)
        likeRepository.countAll(pageable)
    }
